...
class MOD_mktop_pipelined : public Module {
 ...
 /* Local definitions */
 private:
  tUWide DEF_rv_core_getMMIOReq___d124;
  tUWide DEF_rv_core_getDReq___d113;
  tUWide DEF_rv_core_getIReq___d105;
  tUWide DEF_cache_getRespInstr___d109;
  tUWide DEF_mmioreq_first____d141;
  tUWide DEF_dreq___d117;
  tUInt32 DEF__read__h3216;
  tUInt8 DEF__0_CONCAT_DONTCARE___d26;
  tUWide DEF_dreq_17_BITS_67_TO_32_18_CONCAT_cache_getRespD_ETC___d120;
