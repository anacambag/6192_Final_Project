...
/* Generation options: */
#ifndef __mkCache32_data_h__
#define __mkCache32_data_h__
...
/* Class declaration for the mkCache32_data module */
class MOD_mkCache32_data : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkCache32_data(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkCache32_data &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkCache32_data &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkCache32_data &backing);
};

#endif /* ifndef __mkCache32_data_h__ */
